...
static const MIDL_STUB_DESC InterfaceRPC_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& InterfaceRPC_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION InterfaceRPC_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE InterfaceRPC_NDR64__v1_0_DispatchTable = 
    {
    6,
    (RPC_DISPATCH_FUNCTION*)InterfaceRPC_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO InterfaceRPC_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&InterfaceRPC_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE InterfaceRPC_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)_size,
    (SERVER_ROUTINE)_delete,
    (SERVER_ROUTINE)_check,
    (SERVER_ROUTINE)_download,
    (SERVER_ROUTINE)_upload,
    (SERVER_ROUTINE)rpc_close
    };
...
static const MIDL_SERVER_INFO InterfaceRPC_ServerInfo = 
    ...
    interfaceRPC__MIDL_ProcFormatString.Format,
    (unsigned short *) InterfaceRPC_FormatStringOffsetTable,
    0,
